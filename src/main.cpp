...
#include "../res/texture/stb_image.h"
...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("res/Shaders/vs.shader", "res/Shaders/fs.shader");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (unsigned int i = 0; i < 10; i++)
        {
            ...
            model = glm::rotate(model, (float)glfwGetTime() * glm::radians(25.0f * (i + 1)), glm::vec3(1.0f, 0.5f, 0.3f));
